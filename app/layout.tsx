...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body  className={`${inter.className} h-[640vh] lg:h-[700vh] bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
