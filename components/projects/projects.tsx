      ...
      <div className="absolute inset-0 z-10 grid place-content-center transition sm:group-even:pl-8">
        ...
        ">
          ...
          <AnimatedBody text={card.description} 
                          className={"mt-4 w-fit leading-relaxed flex justify-center text-white/70 lg:group-odd:text-left lg:group-even:pr-[2rem] lg:group-even:text-right text-center"}/>
