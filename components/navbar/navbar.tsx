...
export default function Navbar() {
    ...
    <header className='z-[999] fixed top-0'>
        <motion.div className="fixed left-1/2 bottom-[4.5rem] md:bottom-[1.75rem] lg:bottom-[1.75rem] h-[2.5rem] w-[19rem] rounded-lg border border-white border-opacity-40 bg-white bg-opacity-80 shadow-lg 
        ...
        <nav className='flex fixed w-[30rem] bottom-[4rem] left-1/2 h-12 -translate-x-1/2 sm:h-12 lg:bottom-[1.7rem] sm:py-0'>
